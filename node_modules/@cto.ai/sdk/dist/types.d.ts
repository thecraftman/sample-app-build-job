export declare enum Interfaces {
    Terminal = "terminal",
    Slack = "slack"
}
...
export declare type Questions<A extends Answers = Answers> = Question<A> | Question<A>[] | ReadonlyArray<Question<A>>;
export declare type Answers = Record<string, any>;
...
export declare type Question<A extends Answers = Answers> = InputQuestion<A> | NumberQuestion<A> | SecretQuestion<A> | PasswordQuestion<A> | ConfirmQuestion<A> | ListQuestion<A> | AutoCompleteQuestion<A> | CheckboxQuestion<A> | EditorQuestion<A> | DateTimeQuestion<A>;
